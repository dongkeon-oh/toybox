...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath}/js/admin_js/list_user.js"></script>
			...
			<button class="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation">
		  	...
		  	<div class="navbar-collapse collapse" id="navbarColor02" style="">
			    ...
			    <div class="form-inline my-2 my-lg-0">
				  	...
				  	<input class="form-control mr-sm-2" id="keyword" type="text" placeholder="검색어를 입력하세요" onkeyup="search_keyword('enter')">
			      	<button class="btn btn-secondary my-2 my-sm-0" type="button" onclick="search_keyword('click')">검색</button>
			    </div>
		    </div>
		</nav>
